             ...
             <div class="right-box d-flex flex-wrap">
                 ...
                 <div class="language-dropdown">
                     <a href="?lang=en" class="dropdown-toggle" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown"
                         aria-expanded="false">
                         <i><img style="width: 1.6rem; margin-right: 10px;" src="/images/icons/mxn.svg" alt="" /></i>Esp
                         &nbsp;
                     </a>
                     <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                         <li>
                             <a class="dropdown-item" href="?lang=en">
                                 <i>
                                     <img style="width: 1.6rem; margin-right: 10px;" src="/images/icons/usa-flag.png" alt="" /></i>Eng
                                 &nbsp;
                             </a>
                         </li>
                     </ul>
